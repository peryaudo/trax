...
- [ ] SimpleSearcherをbaselineにして、60%以上強いNegaMax or 評価関数の実現

SimpleSearcherが今のところ一番強いし爆速。
いくらLeafAverageEvaluatorが悪いとはいっても流石にMinMax深くすると弱くなるは信じがたくて、
2段目以降がバグってる結果こうなってる気がする。

Hashes()の実装もいいけど、明らかにこれがどうバグってるかをちゃんと調査するのが先だよな…
